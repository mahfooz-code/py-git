...
def branch_change_author_filter(repo_path):
...
def branch_prefix_messages_filter(repo_path):
...
def branch_custom_filter(repo_path):
...
def branch_filter_low_level_api(repo_path):
...
def main():
    ...
    examples = {
        "change_author": branch_change_author_filter,
        "prefix_messages": branch_prefix_messages_filter,
        "custom_filter": branch_custom_filter,
        "low_level": branch_filter_low_level_api,
    }
